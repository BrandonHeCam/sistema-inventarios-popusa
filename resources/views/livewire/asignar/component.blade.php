        ...
        <div class="widget widget-chart-one">
            ...
            <div class="widget-content">
                <div class="form-inline">
                    ...
                    <button wire:click.prevent="SyncAll()" type="button" class="btn btn-primary mbmobile inblock mr-5">Sincronizar Todos</button>

                    <button onclick="Revocar()" type="button" class="btn btn-danger mbmobile mr-5">Revocar Todos</button>
                </div>
