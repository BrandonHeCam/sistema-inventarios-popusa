...
<div class="col-sm-12 col-md-8">
	<div class="form-group">
		...
		class="form-control" placeholder="ej: Juan Lopez"  >
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		...
		class="form-control" placeholder="ej: 2222654589" maxlength="10" >
...
<div class="col-sm-12 col-md-6">
	<div class="form-group">
		...
		class="form-control" placeholder="ej: example@gmail.com"  >
